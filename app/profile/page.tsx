        ...
        <div className="mb-8">
          <div className="flex items-center gap-6 mb-6">
            ...
            <div className="flex-shrink-0 relative group">
              <div className="w-24 h-24 rounded-full flex items-center justify-center text-4xl font-bold text-white shadow-lg overflow-hidden" style={{ backgroundColor: '#A0CEFD' }}>
            ...
            <div className="flex-1">
              <h1 className="text-4xl font-bold mb-2" style={{ color: '#A0CEFD' }}>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="p-4 rounded-lg overflow-hidden min-h-[120px] flex flex-col justify-between" style={{ backgroundColor: '#E4F2FF' }}>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-md" style={{ backgroundColor: '#A0CEFD' }}>
